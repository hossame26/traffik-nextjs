        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center rounded-3xl bg-gradient-to-br from-[#0066FF] to-purple-700 p-10 md:p-14 relative overflow-hidden mb-20">
            <div className="relative z-10">
              ...
              <MagneticButton href="https://wa.me/33635505374" className="inline-flex items-center gap-3 px-8 py-4 bg-white text-[#0066FF] font-bold rounded-full hover:shadow-xl shadow-lg shadow-white/20 transition-all"><MessageCircle className="w-5 h-5" /> Discuter sur WhatsApp</MagneticButton>
            </div>
          </motion.div>
        </div>
      </div>
